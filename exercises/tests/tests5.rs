...
unsafe fn modify_by_address(address: usize) {
    // SAFETY: The address is assumed to be valid and pointing to a mutable u32 value
    // as per the function's contract. We're converting the address back to a raw pointer
    // and modifying the value it points to.
    unsafe {
